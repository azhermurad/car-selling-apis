...
//         return Promise.resolve({ id: 1, email, password,isAdmin:false } as User)
//       },
...
//       Promise.resolve([
//         { id: 1, email: 'azher@gamil.com', password: '134567' } as User,
//       ]);
...
//       fakeSevices.getUsersByEmail = () =>
//         Promise.resolve([
//           { id: 1, email: 'azher@gamil.com', password: hashPassword } as User,
//         ]);
